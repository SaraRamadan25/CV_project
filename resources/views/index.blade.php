...
<main class="site-wrapper">
    <div class="pt-table">
        <div class="pt-tablecell page-home relative" style="background-image: url('assets/theme/images/banner.jpg');">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                        <div class="page-title home text-center">
                            <img src="assets/theme/images/phantom.png" alt="">
                        ...
                        <div class="hexagon-menu clear">
                            <div class="hexagon-item">
                                ...
                                <a href="{{ route('welcome.index') }}" class="hex-content">
                  <span class="hex-content-inner">
                    ...
                    <span class="title">Welcome</span>
                            ...
                            <div class="hexagon-item">
                                ...
                                <a href="{{ route('user.index') }}" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                    ...
                    <span class="title">About</span>
                            ...
                            <div class="hexagon-item">
                                ...
                                <a href="{{ route('service.index') }}" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                    ...
                    <span class="title">Services</span>
                            ...
                            <div class="hexagon-item">
                                ...
                                <a href="{{ route('education.index') }}" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i class="tf-tools"></i>
                    </span>
                    <span class="title">Resume</span>
                            ...
                            <div class="hexagon-item">
                                ...
                                <a href="{{ route('project.index') }}" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                    ...
                    <span class="title">Works</span>
                            ...
                            <div class="hexagon-item">
                                ...
                                <a href="{{ route('testimonial.index') }}" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i class="tf-chat"></i>
                    </span>
                    <span class="title">Testimonials</span>
                            ...
                            <div class="hexagon-item">
                                ...
                                <a href="{{ route('contact.create') }}" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
